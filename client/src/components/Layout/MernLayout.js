                                    ...
                                    {(provided, snapshot) => 
                                        <div 
                                            ...
                                            {...provided.dragHandleProps}>
                                                <MernComponent style={{boxShadow: snapshot.isDragging ? '10px 10px 8px 5px rgba(0,0,0,0.3)' : '3px 3px 2px 2px rgba(0,0,0,0.5)'}} getComponents={this.props.getComponents} {...comp}/>
                                        </div> }
                                </Draggable>
                            )}
                        </div>
